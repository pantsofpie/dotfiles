...
let g:dracula#palette.comment   = ['#29a9aa', 116]
let g:dracula#palette.selection = ['#44475A', 239]
let g:dracula#palette.subtle    = ['#008183', 238]

let g:dracula#palette.cyan      = ['#8BE9FD', 117]
let g:dracula#palette.green     = ['#50FA7B',  84]
let g:dracula#palette.orange    = ['#FFB86C', 215]
let g:dracula#palette.pink      = ['#d76801', 172]
let g:dracula#palette.purple    = ['#29a9aa', 116]
...
let g:dracula#palette.color_4  = '#008183'
let g:dracula#palette.color_5  = '#a94100'
...
let g:dracula#palette.color_12 = '#29a9aa'
let g:dracula#palette.color_13 = '#d76801'
